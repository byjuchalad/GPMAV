/*
GPM Antivirus - Scanner GUI
Copyright (C) 2010-2014  GPM

File Description: Creates a child process that runs a user-specified command and redirects its
standard output and standard error to a CEdit control.
Original Author: Matt Brunk
Modified by: GPM

Credits: Matt Brunk
		 Dima Shamroni (dima@abirnet.co.il)

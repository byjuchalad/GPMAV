...
'
'File Description: ACleaner - Temp file scanning and cleaning software
'Original Author: Ernest Jr
'Modified by: GPM
'
'Credits: VBForums - Ernest Jr
...
#Region " Methods "
    ...
    Public Sub Scan(ByVal lvw As ListView)
        If Directories.Count = 0 And Files.Count = 0 And Registry.Count = 0 Then
            MessageBox.Show("Please choose some items to scan!",
                            "INVALID ARGUMENT", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
        Else
